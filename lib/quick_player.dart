...
final MethodChannel _channel = const MethodChannel('flutter.io/quickPlayer')
...
///
/// The video is displayed in a Flutter app by creating a [QuickPlayer] widget.
///
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  EventChannel _eventChannelFor(int textureId) {
    return EventChannel('flutter.io/quickPlayer/videoEvents$textureId');
  }
...
class QuickPlayer extends StatefulWidget {
  QuickPlayer(this.controller);

  final VideoPlayerController controller;

  @override
  _QuickPlayerState createState() => _QuickPlayerState();
}

class _QuickPlayerState extends State<QuickPlayer> {
  _QuickPlayerState() {
    _listener = () {
  ...
  @override
  void didUpdateWidget(QuickPlayer oldWidget) {
