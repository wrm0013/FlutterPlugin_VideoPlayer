package io.flutter.plugin.quick_player;
 ...
 * QuickPlayerPlugin
 */
public class QuickPlayerPlugin implements MethodCallHandler {

    private static class QuickPlayer {
    ...
    public static void registerWith(Registrar registrar) {
        final QuickPlayerPlugin plugin = new QuickPlayerPlugin(registrar);
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter.io/quickPlayer");
    ...
    private QuickPlayerPlugin(Registrar registrar) {
        this.registrar = registrar;
        this.videoPlayers = new LongSparseArray<>();
    }

    private final LongSparseArray<QuickPlayer> videoPlayers;
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        switch (call.method) {
            ...
            case "create":
            {
                ...
                EventChannel eventChannel =
                        new EventChannel(
                                registrar.messenger(), "flutter.io/quickPlayer/videoEvents" + handle.id());
            ...
            default:
            {
                ...
                QuickPlayer player = videoPlayers.get(textureId);
                if (player == null) {
                    result.error(
                            "Unknown textureId",
    ...
    private void onMethodCall(MethodCall call, Result result, long textureId, QuickPlayer player) {
        switch (call.method) {
            case "setLooping":
